            ...
            <section>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <form action="index.php" method="get"><td><input type="submit" value="edit" name="button"></td></form>
                        <form action="index.php" method="get"><td><input type="submit" value="delete" name="button"></td></form>
                    </tr>
                    <?php endforeach; ?>
                </table>
